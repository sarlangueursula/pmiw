...
function preload() {
  imagenes[0] = loadImage('https://i.imgur.com/0yOROFb.png');
  imagenes[1] = loadImage('https://i.imgur.com/Tf9iMdk.png');
  imagenes[2] = loadImage('https://i.imgur.com/ZrsLXOx.png');
  imagenes[3] = loadImage('https://i.imgur.com/VENPFvB.png');
  imagenes[4] = loadImage('https://i.imgur.com/K0I6mbT.png');
  imagenes[5] = loadImage('https://i.imgur.com/Gv7VAVu.png');
  imagenes[6] = loadImage('https://i.imgur.com/pRsgiNw.png');
  imagenes[7] = loadImage('https://i.imgur.com/Z7gaowP.png');
  imagenes[8] = loadImage('https://i.imgur.com/kK0XX9Y.png');
  imagenes[9] = loadImage('https://i.imgur.com/T6cviUl.png');
  imagenes[10] = loadImage('https://i.imgur.com/YGYpA7B.png');
  imagenes[11] = loadImage('https://i.imgur.com/AfsmUDm.png');
  imagenes[12] = loadImage('https://i.imgur.com/GPT4SSb.png');
  imagenes[13] = loadImage('https://i.imgur.com/wBW3c0C.png');
  
  sonidoClick = loadSound('Boton.mp3');
  musicaDefault = loadSound('Fondo.mp3');
  musicaFinalBueno = loadSound('FinalBueno.mp3');
  musicaFinalMalo = loadSound('FinalMalo.mp3');
}
